...
`;function Su(t){var n=t,{className:e}=n,D=O(n,["className"]);const s=i.exports.useContext(X);return u(z0,{className:e,anchor:s.anchor,open:s.open,variant:s.permanent,onClose:()=>{s.closeDrawer(!1)},children:u(Y,{className:"drawer-layout",sx:{width:s.anchor==="top"||s.anchor==="bottom"?"auto":250},role:"presentation",onClick:()=>{s.closeDrawer(!1)},children:u(s.child,{})})})}const vu=b(Su)`
  color: #F4F5F7;
...
`;function Bu({className:e}){return u("div",{id:"",className:e})}const Nu=b(Bu)`
  ...
  width: 0px !important;
`;function Tu({className:e}){const[D,t]=i.exports.useState(!1),[n,s]=i.exports.useState(""),[E,c]=i.exports.useState(!1),o=i.exports.useContext(R),m=i.exports.useContext(q);i.exports.useEffect(()=>{s(o.title)},[o.title]),i.exports.useEffect(()=>{r()},[]);const r=()=>{I.getMobileOS()&&c(!0)};function g(){if(I.getMobileOS()){const f=document.querySelectorAll(".gsc-control-cse")[0];f.style.visibility="visible",f.style.marginTop="90px"}}i.exports.useEffect(()=>{window.onload=()=>{if(document.querySelector("#gcse-my-wrapper #___gcse_0"))g(),k();else{let A=function(){k()};const x=document.querySelector("#gcse-my-wrapper"),S={childList:!0,attributes:!0,subtree:!1};new MutationObserver(A).observe(x,S)}}},[]);function k(){t(!0);const f=document.querySelectorAll("#___gcse_0 .gsc-results-wrapper-nooverlay")[0],A={childList:!1,attributes:!0,subtree:!1};function x(){z()}new MutationObserver(x).observe(f,A)}function N(f){s(f.target.value),T(f)}const z=()=>{setTimeout(()=>{let f=document.querySelectorAll(".gs-title:not(.gsc-table-cell-thumbnail)");f&&f.forEach((A,x)=>{if(A.innerText.includes("Lyrics")){if(A.innerText.includes("(")){let B=A.innerText.match(/\(([^)]+)\)/)[1].toLowerCase();if((B==null?void 0:B.includes("live"))||(B==null?void 0:B.includes("mix"))||(B==null?void 0:B.includes("remix"))){A.parentElement.parentElement.parentElement.remove();return}}let S=A.innerText.split("Lyrics")[0];S=S.replaceAll("\u2013","-"),A.innerText=S;const J={artistName:encodeURI(S.split("-")[0]),songName:encodeURI(S.split("-")[1])};A.nodeName!=="A"&&A.parentElement.parentElement.parentElement.addEventListener("click",B=>{var V;((V=m.error)==null?void 0:V.open)&&m.closeBanner("error"),A.parentElement.parentElement.parentElement.parentElement.style.pointerEvents="none",o.getLines(J,S)}),A.style.display="block"}else A.innerText.includes("Lyrics")||A.parentElement.parentElement.parentElement.className.includes("gsc-webResult")&&A.parentElement.parentElement.parentElement.remove()})},50)};function T(f){m.error&&m.closeBanner("error");let A=document.querySelector("#gsc-i-id1"),x=/^[~`!@#$%^&*()_+=[\]\{}|;':",.\/<>?a-zA-Z0-9- ]+$/;if(A)if(f.target.value.length<=1){let S=document.querySelector(".gsst_a");S&&S.dispatchEvent(new Event("click"))}else if(x.test(f.target.value)){A.value=f.target.value;let S=document.querySelectorAll(".gsc-search-box button")[0];S?setTimeout(()=>{S.dispatchEvent(new Event("click"))},50*Math.floor(Math.random()*4)):(m.createBanner("error","error","\u05DE\u05E9\u05D4\u05D5 \u05D4\u05E9\u05EA\u05D1\u05E9, \u05E0\u05E1\u05D4 \u05DC\u05E8\u05E2\u05E0\u05DF \u05D0\u05EA \u05D4\u05E2\u05DE\u05D5\u05D3","(no gsc loaded)"),console.error("no gsc loaded, try reload the page"))}else{m.createBanner("error","error","\u05D4\u05D6\u05DF \u05D0\u05E0\u05D2\u05DC\u05D9\u05EA \u05D1\u05DC\u05D1\u05D3","");return}else m.createBanner("error","error","\u05DE\u05E9\u05D4\u05D5 \u05D4\u05E9\u05EA\u05D1\u05E9, \u05E0\u05E1\u05D4 \u05DC\u05E8\u05E2\u05E0\u05DF \u05D0\u05EA \u05D4\u05E2\u05DE\u05D5\u05D3","(no gsc loaded)"),console.error("no gsc loaded, try reload the page")}return h("div",{id:"",className:e,children:[!E&&u(J0,{id:"outlined-search",label:"\u05D7\u05D9\u05E4\u05D5\u05E9 \u05E9\u05D9\u05E8",type:"search",className:"main-input",onChange:D?N:null,autoFocus:!1,autoComplete:"off",value:n}),u("div",{id:"gcse-my-wrapper",children:u("div",{className:"gcse-search"})})]})}const ku=b(Tu)`
...
`;function Iu(t){var n=t,{className:e}=n,D=O(n,["className"]);const s=i.exports.useContext(e0),[E,c]=i.exports.useState(!1),[o,m]=i.exports.useState([]),r=()=>{c(!0),o[0]||k()},g=()=>{c(!1)};function k(){const z="https://musicline-backend.vercel.app";let T=D.lyric.trim().toLowerCase();T=T.replaceAll(/[^a-zA-Z0-9']/g,""),T.slice(-1)==="'"&&(T=T.replaceAll("'","g")),fetch(`${z}/trans/single`,{method:"post",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({single:encodeURI(T)})}).then(f=>f.json()).then(f=>{if(f==null?void 0:f.results[0]){m(f.results);return}else{m(["\u05DC\u05D0 \u05E0\u05DE\u05E6\u05D0"]);return}}).catch(f=>{console.log(f)})}const N=()=>o[0]?o.map((z,T)=>h(U,{children:[T>0&&u("hr",{}),u("p",{className:"tt-p",children:z})]})):u("p",{className:"tt-p",children:"\u05DC\u05D0 \u05E0\u05DE\u05E6\u05D0\u05D5 \u05E2\u05D5\u05D3"});return u(j0,{onClickAway:g,children:u(H0,{className:e,title:h(U,{children:[u($,{color:"inherit",style:{fontSize:s.fontSize.sm>=18?s.fontSize.sm-8:s.fontSize.sm,textAlign:"center"},children:" \u05EA\u05E8\u05D2\u05D5\u05DE\u05D9\u05DD \u05E0\u05D5\u05E1\u05E4\u05D9\u05DD: "}),u("div",{className:"tt-body",style:{textAlign:"center",maxHeight:"110px",overflowY:"auto",direction:"ltr",fontSize:s.fontSize.sm>=18?s.fontSize.sm-10:s.fontSize.sm,padding:"3%"},children:o[0]?u(N,{}):u(l0,{sx:{margin:"8px"},color:"inherit"})})]}),arrow:!0,leaveTouchDelay:60*1e3,leaveDelay:0,PopperProps:{disablePortal:!1},onClose:g,open:E,disableFocusListener:!0,disableTouchListener:!0,disableHoverListener:!0,children:h("p",{className:"single-lyric",onClick:r,children:["\xA0 ",D.lyric," "]})})})}const E0=b(Iu)`

`;function Fu(t){var n=t,{className:e}=n,D=O(n,["className"]);const s=i.exports.useContext(R),E=i.exports.useContext(e0);return u(Y,{className:e,children:u(F,{container:!0,spacing:2,children:s.lines&&s.currLyrics&&h("div",{id:"lyrics_body",children:[u($,{variant:"h6",noWrap:!0,component:"h3",style:{fontSize:E.fontSize.lg},children:s.title&&s.title.split(" ").map((c,o)=>u(E0,{lyric:c},o))}),s.lines.map((c,o)=>{var m;return c.src.includes("[")&&(c.trans="   "),h("div",{children:[o>0&&c.src.includes("[")&&h(U,{children:[u("br",{}),u("br",{})]}),u(F,{className:"lyrics-line en-line",item:!0,style:{fontSize:E.fontSize.md},children:c.src.split(" ").map((r,g)=>u(E0,{lyric:r},g+Math.random()))}),u(F,{item:!0,className:"lyrics-line he-line",style:{fontSize:E.fontSize.sm},children:u(U,{children:((m=c.trans)==null?void 0:m.length)>2?c.trans.split(" ").map((r,g)=>{if(c.trans!=="   ")return h("small",{className:"single-trans",children:[r," \xA0"]},g+Math.random())}):u("small",{className:"single-trans",children:"\u05D8\u05D5\u05E2\u05DF \u05EA\u05E8\u05D2\u05D5\u05DD..."})})})]},o)})]})})})}const zu=b(Fu)`
#lyrics_body{
...
`;function ju({className:e}){var g,k;const D=i.exports.useContext(X),t=i.exports.useContext(u0),n=i.exports.useContext(q),[s,E]=i.exports.useState("\u05DE\u05EA\u05D5\u05E8\u05D2\u05DE\u05D9\u05D5\u05D6\u05D9\u05E7 - \u05E9\u05D9\u05E8\u05D9\u05DD \u05DE\u05EA\u05D5\u05E8\u05D2\u05DE\u05D9\u05DD \u05DE\u05D0\u05E0\u05D2\u05DC\u05D9\u05EA");i.exports.useRef(null);const c=U0({key:"muirtl",stylisPlugins:[Q0,Y0]});function o(){m()}const m=()=>{const N=document.createElement("script");N.type="text/javascript",N.src="https://cse.google.com/cse.js?cx=a85c2374ffc8b8898",N.defer=!0,document.body.appendChild(N)};i.exports.useEffect(()=>{o()},[n]);const r=N=>{n.closeBanner(N)};return a0({palette:{mode:"dark"}}),h("div",{className:e,children:[u(q0,{value:c,children:h(V0,{hashType:"noslash",children:[u(nu,{currTitle:s}),u(Cu,{className:"header"}),((g=n.main)==null?void 0:g.open)&&h(D0,{severity:"warning",className:"main-alert",children:[u(c0,{children:n.main.title}),n.main.message]}),u(xu,{children:h(W0,{children:[u(K,{path:"/",element:u(i0,{className:"page"})}),u(K,{path:"songs/:sname",element:u(i0,{className:"page"})}),u(K,{path:"/About",element:u(_u,{className:"page"})}),u(K,{path:"*",element:u(Ju,{className:"page"})})]})}),D.open&&D.child&&u(vu,{className:"drawer"}),t.circular.open&&u(Z0,{color:t.main.color||"primary"}),((k=n.iosSnackbar)==null?void 0:k.open)&&u(K0,{open:n.iosSnackbar.open,autoHideDuration:6e3,onClose:()=>{},children:u(D0,{onClose:()=>{r("iosSnackbar")},severity:n.iosSnackbar.severity,sx:{width:"100%"},children:n.iosSnackbar.message})}),u("br",{}),u("br",{}),u("ins",{className:"adsbygoogle",style:{display:"block",margin:"10px"},"data-ad-format":"autorelaxed","data-ad-client":"ca-pub-8294214228053744","data-ad-slot":"2008052409"}),u(bu,{})]})}),u(Nu,{})]})}const Hu=b(ju)`
  height: 100vh;
  height: fit-content;
  min-height: 700px;
  color: ${e=>e.theme.palette.primary.contrastText};
...
`,Gu=[Du,ru,tu,mu,au];function Uu(e){return u(U,{children:Gu.reduceRight((D,t)=>u(t,{children:D}),e.children)})}X0.render(u(_.StrictMode,{children:u(Uu,{children:u(uu,{theme:p0,children:u(Hu,{className:"app"})})})}),document.getElementById("root"));
