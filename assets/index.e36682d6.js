var he=Object.defineProperty,ge=Object.defineProperties;var fe=Object.getOwnPropertyDescriptors;var U=Object.getOwnPropertySymbols;var oe=Object.prototype.hasOwnProperty,ie=Object.prototype.propertyIsEnumerable;var se=(u,t,r)=>t in u?he(u,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):u[t]=r,y=(u,t)=>{for(var r in t||(t={}))oe.call(t,r)&&se(u,r,t[r]);if(U)for(var r of U(t))ie.call(t,r)&&se(u,r,t[r]);return u},I=(u,t)=>ge(u,fe(t));var $=(u,t)=>{var r={};for(var n in u)oe.call(u,n)&&t.indexOf(n)<0&&(r[n]=u[n]);if(u!=null&&U)for(var n of U(u))t.indexOf(n)<0&&ie.call(u,n)&&(r[n]=u[n]);return r};import{R as j,r as a,j as e,c as ce,M as ye,a as h,B as xe,b as H,d as Ce,A as be,s as S,L as ee,N as te,e as V,f as Y,g as Se,h as Ae,i as q,I as we,k as ve,l as Le,m as Ee,C as ke,T as Ie,n as P,o as Ne,p as ue,q as de,G as z,t as Te,u as X,v as Be,w as ze,D as Fe,x as Oe,y as $e,z as Pe,E as Me,F as _e,H as Re,J as je,K as R,O as Je,P as Ge,Q as He,S as qe,U as De,V as We,W as Ue,X as Ve,Y as Ye,Z as Ze,_ as Ke}from"./vendor.2b355312.js";const Qe=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const D of s)if(D.type==="childList")for(const E of D.addedNodes)E.tagName==="LINK"&&E.rel==="modulepreload"&&n(E)}).observe(document,{childList:!0,subtree:!0});function r(s){const D={};return s.integrity&&(D.integrity=s.integrity),s.referrerpolicy&&(D.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?D.credentials="include":s.crossorigin==="anonymous"?D.credentials="omit":D.credentials="same-origin",D}function n(s){if(s.ep)return;s.ep=!0;const D=r(s);fetch(s.href,D)}};Qe();const Z=j.createContext(void 0);function Xe(u){const[t,r]=a.exports.useState({}),D={openDrawer:(E,o,m="temporary",x)=>{r({open:E,anchor:o,permanent:m,child:x})},closeDrawer:(E,o,m="temporary",x)=>{r({open:E,anchor:o,permanent:m,child:x})}};return e(Z.Provider,{value:y(y({},t),D),children:u.children})}const K=j.createContext(void 0);function eu(u){const[t,r]=a.exports.useState({main:{open:!1,color:"inherit"},circular:{open:!1,color:"inherit"}}),E={createLoader:(o,m)=>{t[o]&&r(I(y({},t),{[o]:void 0})),r(I(y({},t),{[o]:{open:!1,color:m||"inherit"}}))},openLoader:o=>{t[o]?r(I(y({},t),{[o]:I(y({},t[o]),{open:!0})})):console.error("Loader does'nt exist. Name: "+o)},closeLoader:o=>{t[o]?r(I(y({},t),{[o]:I(y({},t[o]),{open:!1})})):console.error("Loader does'nt exist. Name: "+o)}};return e(K.Provider,{value:y(y({},t),E),children:u.children})}const W=j.createContext(void 0);function uu(u){const[t,r]=a.exports.useState({main:{open:!1,severity:"warning",title:"\u05D4\u05D0\u05EA\u05E8 \u05D1\u05D1\u05E0\u05D9\u05D4",message:""},snackbar:{open:!1,severity:"success",title:"",message:"This is a Snackbar!"}}),E={createBanner:(o,m,x,g)=>{t[o]&&r(I(y({},t),{[o]:void 0})),r(I(y({},t),{[o]:{open:!0,severity:m||"success",title:x||"",message:g||""}}))},openBanner:o=>{t[o]?r(I(y({},t),{[o]:I(y({},t[o]),{open:!0})})):console.error("Banner does'nt exist. Name: "+o)},closeBanner:o=>{t[o]?r(I(y({},t),{[o]:I(y({},t[o]),{open:!1})})):console.error("Banner does'nt exist. Name: "+o)}};return e(W.Provider,{value:y(y({},t),E),children:u.children})}const pe=ce({direction:"rtl",typography:{fontFamily:["Assistant","Roboto","sans-serif"].join(",")},palette:{primary:{main:"#DF808E",light:"#fff",dark:"#F43C6A",contrastText:"#555555"},secondary:{main:"#42B983",dark:"#262626",light:"#fcfcfc",contrastText:"#C0A8E6"}}});function tu(){const[u]=a.exports.useState(pe.palette.primary.main);return e("div",{className:"wrapper",children:e(ye,{children:e("meta",{name:"theme-color",content:u})})})}const ru=u=>{localStorage.getItem("meturgamm_songs")||localStorage.setItem("meturgamm_songs",JSON.stringify([]));const t=JSON.parse(localStorage.getItem("meturgamm_songs"));t.push(u),t.length>=500&&t.shift(),localStorage.setItem("meturgamm_songs",JSON.stringify(t))},nu=u=>localStorage.getItem("meturgamm_songs")?JSON.parse(localStorage.getItem("meturgamm_songs")).find(r=>r.title.toLowerCase()===u.toLowerCase()):!1,su=()=>{let u=document.querySelector(".gsst_a");u&&u.dispatchEvent(new Event("click"))},ou=()=>{let u=!1;const t=navigator.userAgent;return/android/i.test(t)?u=!1:(/iPad|iPhone|iPod/.test(t)||navigator.platform==="MacIntel"&&navigator.maxTouchPoints>1)&&(u=!0),u};var O={lsSaveSong:ru,lsGetSong:nu,clearGsc:su,getMobileOS:ou};const Q=j.createContext(void 0);function iu(u){const t=JSON.parse(localStorage.getItem("fontsize")),[r,n]=a.exports.useState({fontSize:{sm:Number(t==null?void 0:t.sm)||22,md:Number(t==null?void 0:t.md)||25,lg:Number(t==null?void 0:t.lg)||27},colors:"pink"}),s=()=>{r.fontSize.md<60&&(n(I(y({},r),{fontSize:{sm:r.fontSize.sm+1,md:r.fontSize.md+1,lg:r.fontSize.lg+1}})),E())},D=()=>{r.fontSize.sm>7&&(n(I(y({},r),{fontSize:{sm:r.fontSize.sm-1,md:r.fontSize.md-1,lg:r.fontSize.lg-1}})),E())};function E(){localStorage.setItem("fontsize",JSON.stringify({sm:r.fontSize.sm,md:r.fontSize.md,lg:r.fontSize.lg}))}function o(){localStorage.setItem("colors_mode",r.colors)}function m(g){n(I(y({},r),{colors:g})),o()}const x={reduceFontSize:D,increaseFontSize:s,setColors:m};return e(Q.Provider,{value:y(y({},r),x),children:u.children})}function Du({className:u}){const t=a.exports.useContext(Q);return e("div",{id:"",className:u,children:h(xe,{className:"button-group",children:[e(H,{"aria-label":"reduce",onClick:()=>{t.reduceFontSize()},children:e(Ce,{fontSize:"small"})}),e(H,{className:"font-size-disabled",disabled:!0,children:"\u05D2\u05D5\u05D3\u05DC \u05D4\u05D8\u05E7\u05E1\u05D8"}),e(H,{"aria-label":"increase",onClick:()=>{t.increaseFontSize()},children:e(be,{fontSize:"small"})})]})})}const au=S(Du)`
  text-align: end;
