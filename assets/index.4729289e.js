...
`;function R0({className:e}){return d("div",{id:"NO_MATCH_WRAPPER",className:e,children:[u($,{variant:"h2",className:"page-h2",children:"404"}),u($,{variant:"h3",className:"page-h3",children:"Nothing Here"})]})}const j0=b(R0)`

`;function J0({className:e}){var h,k;const D=E.exports.useContext(X),t=E.exports.useContext(uu),n=E.exports.useContext(q),[s,i]=E.exports.useState("\u05DE\u05EA\u05D5\u05E8\u05D2\u05DE\u05D9\u05D5\u05D6\u05D9\u05E7 - \u05E9\u05D9\u05E8\u05D9\u05DD \u05DE\u05EA\u05D5\u05E8\u05D2\u05DE\u05D9\u05DD \u05DE\u05D0\u05E0\u05D2\u05DC\u05D9\u05EA");E.exports.useRef(null);const c=Uu({key:"muirtl",stylisPlugins:[Qu,Yu]});function o(){g()}const g=()=>{const N=document.createElement("script");N.type="text/javascript",N.src="https://cse.google.com/cse.js?cx=a85c2374ffc8b8898",N.defer=!0,document.body.appendChild(N)};E.exports.useEffect(()=>{o()},[n]);const r=N=>{n.closeBanner(N)};return au({palette:{mode:"dark"}}),d("div",{className:e,children:[u(qu,{value:c,children:d(Vu,{hashType:"noslash",children:[u(n0,{currTitle:s}),u(C0,{className:"header"}),((h=n.main)==null?void 0:h.open)&&d(Du,{severity:"warning",className:"main-alert",children:[u(cu,{children:n.main.title}),n.main.message]}),u(x0,{children:d(Wu,{children:[u(K,{path:"/",element:u(Eu,{className:"page"})}),u(K,{path:"songs/:sname",element:u(Eu,{className:"page"})}),u(K,{path:"/About",element:u(_0,{className:"page"})}),u(K,{path:"*",element:u(j0,{className:"page"})})]})}),D.open&&D.child&&u(v0,{className:"drawer"}),t.circular.open&&u(Zu,{color:t.main.color||"primary"}),((k=n.iosSnackbar)==null?void 0:k.open)&&u(Ku,{open:n.iosSnackbar.open,autoHideDuration:6e3,onClose:()=>{},children:u(Du,{onClose:()=>{r("iosSnackbar")},severity:n.iosSnackbar.severity,sx:{width:"100%"},children:n.iosSnackbar.message})}),u("script",{async:!0,src:"https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8294214228053744",crossOrigin:"anonymous"}),u("ins",{className:"adsbygoogle",style:{display:"block"},"data-ad-format":"autorelaxed","data-ad-client":"ca-pub-8294214228053744","data-ad-slot":"2008052409"}),d("script",{children:["(adsbygoogle = window.adsbygoogle || []).push(",");"]}),u(b0,{})]})}),u(N0,{})]})}const H0=b(J0)`
  height: 100vh;
  height: fit-content;
  min-height: 700px;
  color: ${e=>e.theme.palette.primary.contrastText};
...
`,G0=[D0,r0,t0,m0,a0];function U0(e){return u(U,{children:G0.reduceRight((D,t)=>u(t,{children:D}),e.children)})}Xu.render(u(_.StrictMode,{children:u(U0,{children:u(u0,{theme:du,children:u(H0,{className:"app"})})})}),document.getElementById("root"));
